  ...
  <div class="main">
    <div class="bg-corporativa">
      <div class="container">
        ...
        <!-- <div v-if="page.image !== null" class="row justify-content-center text-center" >
          <figure class="mod__figure">
            <img :src="'data:image/jpeg;base64,' + page.image" />
          </figure>
        </div>
        <div class="space-1 d-none d-md-block"></div> -->
        <div class="row justify-content-center" v-html="page.content">
        </div>
      </div>
...
export default {
  ...
  async asyncData({app}) {
    ...
    const fetchPageData = async () => {
      const page = await legalsService.getLegalTemplate({ id: 1, code });
      return page;
    }
