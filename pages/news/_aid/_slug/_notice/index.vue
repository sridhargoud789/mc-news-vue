              ...
              <article class="mod mod__full-article">
                ...
                <div class="mod__body">
                  ...
                  v-if="newModel.realAuthor !== 'null' &&
                    ...
                    class="mod__text-black">
                    <!--<font-awesome-icon :icon="['fa', 'user-circle']" />-->
                    {{ newModel.realAuthor }}
                  </span>
                  <span v-else class="mod__text-black">
                    <!--<font-awesome-icon class="mod__text-black" :icon="['fas', 'user-circle']" />-->
                    MundoCrypto
                  </span>
                </div>
                ...
                <div class="mod__article-social-links mt-4 mb-4">
                  <ShareNetwork
                      network="facebook"
                      :url="`https://news.mundocrypto.com/news/${$route.params.aid}/${$route.params.slug}/${$route.params.notice}`"
...
export default {
  ...
  async asyncData({ app, req, params, redirect }) {
    ...
    const resp = await fetch(`${link}/api/news/${params.aid}/${params.slug}/${params.notice}.json`)
  ...
  async fetch() {
    ...
    this.categoryString = this.$route.params.slug;
